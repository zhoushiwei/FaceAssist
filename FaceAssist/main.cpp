...
int main(int argc, char** argv) {
	GrabCut grabcut1;
    string imgpath="/Users/zhoushiwei/Pictures/FileRecv/openeyes/135.jpg";
	IplImage* img = cvLoadImage(imgpath.c_str(), CV_LOAD_IMAGE_COLOR);
	IplImage* glass = cvLoadImage("/Users/zhoushiwei/Dropbox/FaceAssist/Data/glass.jpg", CV_LOAD_IMAGE_COLOR);

	string image_basename = getImageID(imgpath.c_str());
	...
	Mat image = imread(imgpath.c_str(), CV_LOAD_IMAGE_COLOR);
	...
	IplImage* mask1 = cvLoadImage("/Users/zhoushiwei/Dropbox/FaceAssist/Data/mask.png", CV_LOAD_IMAGE_GRAYSCALE);
